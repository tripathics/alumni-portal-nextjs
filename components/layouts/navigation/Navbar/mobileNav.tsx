...
const MobileNav: React.FC<{
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "flex flex-col bg-background fixed top-20 left-0 right-0 bottom-0 transition-all ease-in-out duration-700 z-50 clip-rect",
          {
            ["clip-h-line"]: !open,
          }
        )}
      >
        <div className="grow flex flex-col justify-between px-4 pb-6 md:px-8 max-w-screen-xl w-full mx-auto">
          <div></div>
